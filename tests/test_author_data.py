...
def test_author_data_with_same_creation_date():
    ...
    assert check_author_data(author_data, template_author_data) == [('file1.xlsx', 'same_creation_date:2022-01-01 00:00:00'), ('file2.xlsx', 'same_creation_date:2022-01-01 00:00:00')]
